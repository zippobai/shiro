 ...
 */
public class RoleRealmTest {

    @Test
    public void test() throws Exception {
        Factory<SecurityManager> securityManagerFactory = new IniSecurityManagerFactory("classpath:shiro-permission-realm.ini");
        ...
        // 判断是否拥有某些权限
        System.out.println("是否拥有某个角色:" + subject.hasRole("role2"));
